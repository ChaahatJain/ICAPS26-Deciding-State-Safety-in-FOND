...
echo "==============================================="
echo "Running FAULT_ANALYSIS (Tarjan)"
echo "==============================================="
...
../build/PlaJA --engine FAULT_ANALYSIS \
  ...
  --rand-prob 1 \
  --stats-file logs/fault_analysis/tarjansafe_x${x}_y${y}_walls${num_walls}_skip${skip}.csv \
  --print-stats >> logs/fault_analysis/tarjansafe_x${x}_y${y}_walls${num_walls}_skip${skip}.txt

echo "==============================================="
echo "Running FAULT_ANALYSIS (PI3)"
echo "==============================================="
...
../build/PlaJA --engine FAULT_ANALYSIS \
  ...
  --retraining-train-test-split 1.0 \
  --rand-prob 1 \
  --stats-file logs/fault_analysis/pi3_x${x}_y${y}_walls${num_walls}_skip${skip}.csv \
  --print-stats >> logs/fault_analysis/pi3_x${x}_y${y}_walls${num_walls}_skip${skip}.txt
