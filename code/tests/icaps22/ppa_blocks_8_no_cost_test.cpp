...
const std::string modelFile("../../../tests/test_instances/icaps22/blocksworld/models/cost05/blocksworld_8_7.jani"); // NOLINT(*-err58-cpp)
const std::string propertyFile("../../../tests/test_instances/icaps22/blocksworld/additional_properties/safety_verification/cost05/blocksworld_8_7/compact_starts_cost_predicates_afterwards/learned_no_cost/pa_compact_starts_cost_predicates_afterwards_blocksworld_8_7_16_16.jani"); // NOLINT(*-err58-cpp)
...
public:
    ...
    void test_nn_32_prop_8() {
        ...
        TS_ASSERT_EQUALS(ppa->get_stats().get_attr_unsigned(PLAJA::StatsUnsigned::PREDICATES), 81)
        TS_ASSERT_EQUALS(ppa->get_stats().get_attr_unsigned(PLAJA::StatsUnsigned::START_STATES), 4139)
        TS_ASSERT_EQUALS(ppa->get_stats().get_attr_unsigned(PLAJA::StatsUnsigned::EXPANDED_STATES), 6569)
        TS_ASSERT_EQUALS(ppa->get_stats().get_attr_unsigned(PLAJA::StatsUnsigned::TRANSITIONS), 13138)
        TS_ASSERT_EQUALS(ppa->get_stats().get_attr_unsigned(PLAJA::StatsUnsigned::REACHABLE_STATES), 6569)
