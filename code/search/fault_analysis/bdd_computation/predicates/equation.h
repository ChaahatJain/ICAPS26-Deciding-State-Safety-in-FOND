...
//
// Encoding equations Sum_i=1^n a_i*x_i = a_0
#ifndef PLAJA_BDD_EQUATION_H
#define PLAJA_BDD_EQUATION_H
...
namespace BDD_IN_PLAJA {
    class Equation final {
        ...
        public:
            Equation(const std::vector<BDD_IN_PLAJA::Context::Addend>& addends_, int scalar_);
            ~Equation();
            DELETE_CONSTRUCTOR(Equation)
