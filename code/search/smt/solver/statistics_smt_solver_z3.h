...
#ifndef PLAJA_STATISTICS_SMT_SOLVER_Z3_H
#define PLAJA_STATISTICS_SMT_SOLVER_Z3_H
...
namespace Z3_IN_PLAJA { extern void add_solver_stats(PLAJA::StatsBase& stats); }

#endif //PLAJA_STATISTICS_SMT_SOLVER_Z3_H
